...
if(isset($_POST['$timkiem'])){
 ...
 $sql_pro = "SELECT * FROM db_sanpham WHERE tensanpham LIKE '%.$tukhoa' ";
    ...
    <div class="app_container">
            <div class="grid"> 
                ...
                <div class="grid__column-10">
                  ...
                  <span class="home-top">Tìm kiếm sản phẩm:<?php echo $_POST['tukhoa']?></span>
                    </div>
                    <div class="home-product">
                        <div class="grid__row">
                            ...
                            <?php
                             ...
                             ?> <a href="index.php?quanli=sanpham&id=<?php  echo $row_danhmuc['id_sanpham']?>">
